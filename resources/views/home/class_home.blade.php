...
<a href="/people/{{$class->id}}" style="margin-left: 720px;" class="people">People</a>
<div class="container">
...
<form action="/invite/{{$class->id}}" method='post'>
  @csrf
  <input type="text" name="invite_email" placeholder="Enter User's Email address..." style="margin-top:15px; margin-left:420px; width: 620px;" required>
